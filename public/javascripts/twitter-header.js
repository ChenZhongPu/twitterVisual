...
var svg = d3.select("#headerSVG").append("svg")
...
d3.csv("/assets/data/headerData.csv", function(data) {
  ...
  function tweenArc(b) {
    return function(a) {
      ...
      return function(t) {
        ...
        path.attr("d", arc(a));
        text.style('fill', '#FFF')
        .attr("transform", "translate(" + arc.centroid(a) + ")translate(" + w / 2 + "," + h / 2 +")rotate(" + ((a.startAngle + a.endAngle) / 2 + 3 * Math.PI / 2) * 180 / Math.PI + ")");
      };
    }
  }
